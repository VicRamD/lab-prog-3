...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('descripcion', models.CharField(choices=[('comision', 'COMISION DE SEGUIMIENTO'), ('tribunal', 'TRIBUNAL EVALUADOR'), ('defensa', 'DEFENSA TRABAJO FINAL'), ('finalizado', 'FINALIZADO')])),
                ('observacion', models.TextField()),
                ('proyecto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='proyecto_instancia', to='gestion.proyecto')),
            ],
        ),
        migrations.CreateModel(
            name='Evaluacion',
            fields=[
                ...
                ('estado', models.CharField(choices=[('pendiente', 'PENDIENTE'), ('aprobado', 'APROBADO'), ('rechazado', 'RECHAZADO')])),
                ('instancia_evaluacion', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='instancia_evaluacion', to='gestion.instanciaevaluacion')),
            ],
        ),
        migrations.CreateModel(
            name='Defensa',
